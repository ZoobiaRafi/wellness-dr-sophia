                    ...
                    <div id="form">
                        ...
                        <div class="row customer_info mt-3" style="display: none;">
                            ...
                            <form>
                                ...
                                <br>
                                <button style="margin-bottom: 10px;" type="button" data-isbooking="1" class="btn btn-primary btn_place_order btn_signup_order">Pay In Clinic</button>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn_place_order").click(function() {
            var emailValidRegExp = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
            ...
            if (firstname != "") {
                if (lastname != "") {
                    if (dob != "") {
                        if (gender != "") {
                            if (email.match(emailValidRegExp)) {
                                if (contact != "") {
                                    if (contact.length == 12) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                if (response.status == 'notexist') {
                                                    $.ajax({
                                                        url: "/in/clinic/submit?utm_source=" + utm_source + "&utm_medium=" + utm_medium + "&utm_campaign=" + utm_campaign + "&utm_term=" + utm_term,
                                                        type: "POST",
                                                        data: {
                                                            "_token": "{{ csrf_token() }}",
                                                            firstname: firstname,
                                                    ...
                                                    $(".btn_login_order_pay_in_clinic").trigger("click");
                                                }
                                            }
                                        });
                                    } else {
                                        Swal.fire({
                                            position: 'center',
                                            icon: 'warning',
                                            title: 'Please enter valid contact no',
                                            showConfirmButton: false,
                                            timer: 1500
                                        });
                                    }
