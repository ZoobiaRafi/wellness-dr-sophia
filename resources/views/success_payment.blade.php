...
@section('title')
Wellness by Dr.Sophia - Order Placed
@endsection
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <form id="payment_form" action="https://gw1.tponlinepayments.com/paymentform/" method="post">
                    <input type="hidden" name="action" value="SALE">
                    <input type="hidden" name="amount" value="{{ str_replace('.','',$OrderInfo->order_total) }}">
                    <input type="hidden" name="callbackURL" value="{{ $callback }}">
                    <input type="hidden" name="countryCode" value="{{ setting('take-payment.country_code') }}">
                    <input type="hidden" name="currencyCode" value="{{ setting('take-payment.currency_code') }}">
                    <input type="hidden" name="customerAddress" value="{{ $OrderInfo->address }}">
                    <input type="hidden" name="customerEmail" value="{{ $OrderInfo->email }}">
                    <input type="hidden" name="customerName" value="{{ $OrderInfo->customer_detail->name }}">
                    <input type="hidden" name="customerPhone" value="{{ $CustPhone }}">
                    <input type="hidden" name="customerPostCode" value="{{ $CustPostCode }}">
                    <input type="hidden" name="formResponsive" value="Y">
                    <input type="hidden" name="item1Description" value="#OBM{{ $OrderInfo->id }}">
                    <input type="hidden" name="item1GrossValue" value="{{ str_replace('.','',$OrderInfo->order_total) }}">
                    <input type="hidden" name="item1Quantity" value="1">
                    <input type="hidden" name="merchantID" value="{{ setting('take-payment.merchant_id') }}">
                    <input type="hidden" name="orderRef" value="#OBM{{ $OrderInfo->id }}">
                    <input type="hidden" name="redirectURL" value="{{ $redirectback}}">
                    <input type="hidden" name="transactionUnique" value="{{ $UniqueID }}">
