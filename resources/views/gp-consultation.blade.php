...
@section('title')
Wellness by Dr.Sophia - GP Consultation
@endsection
...
<main>
    <section class="banner" style="background-image:url('assets/images/gp-banner.webp');">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6">
                    <img src="/assets/images/gp-banner-dr.webp" alt="dr" class="consult-dr img-fluid w-100">
                </div>
            </div>
        </div>
    </section>

    <section class="about-gp" style="background-image:url('assets/images/luxury-bg.webp');background-size: 100% 100%;">
        <div class="container">
            <h4>About Consultation</h4>
            <hr>
            <div class="row">
                <div class="col-md-5 col-sm-5 col-lg-5">
                    <img src="/assets/images/gp-about.webp" alt="gp-about" class="img-fluid w-100">
                </div>
    ...
    <section class="gp-form" id="gp-form" style="background-image:url('assets/images/expert-banner.webp');background-size: 100% 100%;">
        <div class="container">
            <h4>Schedule Your Consultation Today!</h4>
            <hr>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-lg-6  d-md-block d-none">
                    <img src="/assets/images/gp-form.webp" alt="gp-form" class="img-fluid">
                </div>
